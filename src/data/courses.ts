...
export const courses: Course[] = [
  ...
  },
  {
    id: 'namsan-loop',
    name: '남산 순환 코스',
    description: '남산 순환도로를 따라 오르내리며 서울 야경을 감상할 수 있는 코스.',
    distance: 4.0,
    difficulty: 'medium',
    elevation: 180,
    location: '남산 순환도로',
    region: '서울 중구',
    imageUrl: '/images/course-namsan.jpg',
    rating: 4.6,
    reviewCount: 221,
    coordinates: [
      { lat: 37.5512, lng: 126.9882 },
      { lat: 37.5534, lng: 126.9937 },
    ],
    tags: ['공원', '야경', '남산'],
    createdBy: '서울러너',
  },
  {
    ...
    name: '한강 광나루 코스',
    description: '광나루 한강공원에서 출발하는 장거리 한강변 러닝 코스.',
    distance: 9.5,
    difficulty: 'medium',
    elevation: 10,
    location: '광나루 한강공원',
    region: '서울 강동구',
    imageUrl: '/images/course-gwangnaru.jpg',
    rating: 4.4,
    reviewCount: 142,
    coordinates: [
      { lat: 37.5471, lng: 127.1213 },
      { lat: 37.5510, lng: 127.1280 },
    ],
    tags: ['한강', '장거리'],
    createdBy: '광나루러너',
  },
  {
    id: 'cheonggyecheon',
    name: '청계천 코스',
    description: '청계천을 따라 평지로 달리는 도심 속 러닝 코스. 초보자에게 추천.',
    distance: 3.5,
    difficulty: 'easy',
    elevation: 3,
    location: '청계천',
    region: '서울 종로구',
    imageUrl: '/images/course-cheonggyecheon.jpg',
    rating: 4.3,
    reviewCount: 310,
    coordinates: [
      { lat: 37.5696, lng: 126.9786 },
      { lat: 37.5684, lng: 127.0050 },
    ],
    tags: ['도심', '평지', '초보'],
    createdBy: '도심러너',
  },
  {
    id: 'seoul-forest',
    name: '서울숲 코스',
    description: '서울숲 공원을 산책하듯 달리는 편안한 러닝 코스.',
    distance: 5.8,
    difficulty: 'easy',
    elevation: 20,
    location: '서울숲 공원',
    region: '서울 성동구',
    imageUrl: '/images/course-seoulforest.jpg',
    rating: 4.7,
    reviewCount: 267,
    coordinates: [
      { lat: 37.5447, lng: 127.0374 },
      { lat: 37.5471, lng: 127.0420 },
    ],
    tags: ['공원', '숲', '산책'],
    createdBy: '숲속러너',
  },
